	...
	public boolean onTouch(View pushView, MotionEvent event) {
		...
		// 主点按下
			case MotionEvent.ACTION_DOWN :
				pushBtnLP = (FrameLayout.LayoutParams) pushView
						.getLayoutParams();
			...
			case MotionEvent.ACTION_MOVE :
				...
				imgLP.leftMargin = lastImgLeft
						- ((newWidth - lastImgWidth) / 2);
				imgLP.topMargin = lastImgTop
						- ((newHeight - lastImgHeight) / 2);
				...
				Point imageRB = new Point(mView.getLeft() + mView.getWidth(),
						mView.getTop() + mView.getHeight());
